...
export default function VerifiedUserPage() {
  ...
  const content = statusMap[rawStatus] ?? statusMap.failed;
    ...
    <main className="relative flex min-h-screen flex-col overflow-hidden bg-[var(--page-bg)] text-[var(--text-main)] transition-colors duration-500">
      ...
      <footer className="relative z-10 flex w-full flex-col items-center justify-between gap-6 px-[1.7rem] pb-[2rem] pt-0 text-[11px] font-normal uppercase tracking-[0.18em] text-[#93a0b7] md:flex-row">
        <div className="flex flex-wrap items-center gap-[2.2rem]">
          <Link href="/privacy-policy" className="transition-colors duration-300 hover:text-[var(--brand-primary)]">
            Privacy Policy
          </Link>
          <Link href="/terms-of-service" className="transition-colors duration-300 hover:text-[var(--brand-primary)]">
            Terms of Service
          </Link>
          <Link href="/help-center" className="transition-colors duration-300 hover:text-[var(--brand-primary)]">
            Help Center
          </Link>
        </div>
